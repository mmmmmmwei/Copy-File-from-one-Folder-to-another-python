...
search_dataset_file="CSV FILE THAT CONTAINS ALL THE FILENAMES TO COPY"      #example: "Dataset.csv"
...
def checkFile(src,search_dataset_file,extension):
    global search_success_count, search_target_count
    ...
    for search_file_name in search_dataset:
        ...
        for full_target_file_name in src_file:
            ...
            if full_target_file_name == full_search_file_name:
                ...
                shutil.copy(full_target_file_name_path, dest)
